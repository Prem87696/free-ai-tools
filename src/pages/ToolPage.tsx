...
```
  <div className="max-w-4xl mx-auto">
    ...
    <div className="mt-12 prose prose-slate max-w-none">
      ...
      <p>
        Our free <strong>{tool.name}</strong> allows you to generate
        high-quality content in seconds. Simply enter your requirements in
        the form above, and our advanced AI will handle the rest.
      </p>

      <h3>Why use this tool?</h3>
      <ul>
        <li>
          <strong>Fast & Free:</strong> No registration required.
        </li>
        <li>
          <strong>High Quality:</strong> Powered by advanced AI models.
        </li>
        <li>
