        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          <aside className="lg:col-span-3 space-y-8">
            ...
            <div className="bg-indigo-50 p-6 rounded-xl border border-indigo-100">
              <h3 className="font-bold text-lg mb-2 text-indigo-900">Need Custom AI?</h3>
              <p className="text-indigo-700 text-sm mb-4">Contact us for enterprise solutions and custom AI tool development.</p>
              <Link to="/contact" className="block w-full text-center bg-indigo-600 text-white py-2 rounded-lg hover:bg-indigo-700 transition-colors text-sm font-medium">
                Contact Sales
              </Link>
            </div>
          </aside>
      ...
      <footer className="bg-white border-t border-slate-200 py-12 mt-8">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
            <div className="col-span-1 md:col-span-2">
              ...
              <p className="text-slate-500 text-sm leading-relaxed max-w-md">
                Free AI Tools Platform provides cutting-edge artificial intelligence utilities for content creators, students, and professionals. Generate text, images, and code instantly.
              </p>
            </div>
            <div>
              ...
              <ul className="space-y-2 text-sm text-slate-500">
                ...
                <li><Link to="/tools/ai-email-writer" className="hover:text-indigo-600">Email Writer</Link></li>
                <li><Link to="/tools/ai-blog-writer" className="hover:text-indigo-600">Blog Writer</Link></li>
              </ul>
            </div>
            <div>
          ...
          <div className="border-t border-slate-100 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-slate-400 text-sm">© {new Date().getFullYear()} AI Tools Platform. All rights reserved.</p>
